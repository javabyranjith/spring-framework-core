...
public class SpringSingletonTest {
  ...
  public void setUp() throws Exception {
    applicationContext1 = new FileSystemXmlApplicationContext("config/beanscopes-beans.xml");
    applicationContext2 = new FileSystemXmlApplicationContext("config/beanscopes-beans.xml");
  }
